...
## Notes
- 4 stories were incomplete (Either as Todo, In Progress)
- The majority of user stories on Jira don't list the user story template
- Not all members were assigned a task on Jira (or if they were, they didn't start it)
- Not all tickets were associated with a branch
- Some pull requests were made by the non assignee on Jira
- It would be good to clearly note down the critical path
- It would be good to provide an explanation along with your architecture diagram
